    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.6 25.6">
            <g fill="none" stroke="#fff">
                ...
                <g style={{ strokeWidth: .716 }}>
                    <g style={{ strokeLinecap: 'round' }}>
                        <path d="M12.814 16.467c-.08 2.846.02 5.712.298 6.4s.875 2.05 2.926 1.612c1.713-.367 2.337-1.078 2.607-2.647l.633-5.017M10.356 2.2S1.072-1.596 1.504 7.033c.092 1.836 2.63 13.9 5.66 10.25C8.27 15.95 9.27 14.907 9.27 14.907m6.1-13.4c-.32.1 5.164-2.005 8.282 1.978 1.1 1.407-.175 7.157-3.228 11.687" style={{ strokeLinejoin: 'round' }}/>
                    ...
                    <g style={{ strokeLinejoin: 'round' }}>
                        ...
                        <path d="M11.196 15.753c-.08-.513.168-1.122.433-1.836.398-1.07 1.316-2.14.582-5.537-.547-2.53-4.22-.527-4.22-.184s.166 1.74-.06 3.365c-.297 2.122 1.35 3.916 3.246 3.733" style={{ strokeLinecap: 'round' }}/>
                    </g>
                </g>
                <g fill="#fff" style={{ strokeLinejoin: 'miter' }}>
                ...
                <path d="M20.562 7.095c.05.92-.198 1.545-.23 2.524-.046 1.422.678 3.05-.413 4.68" style={{ strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: .716 }} />
            </g>
        </svg>
    )
}